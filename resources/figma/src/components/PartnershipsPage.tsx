...
import wayToJusticeLogo from 'figma:asset/20515c94f53f1dac230df037612e11b898aa0de3.png';
import spokaneWorkforceLogo from 'figma:asset/f70d8cc2c427b8b8d78c9e08f557a16e7a63e38f.png';
...
export function PartnershipsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative h-[500px] bg-gradient-to-br from-[#004080] to-[#003066] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            >
              <Button 
                className="bg-[#f7941D] hover:bg-[#F79520] text-white px-8 py-6 text-lg rounded-full transition-all duration-200 hover:scale-105"
              >
